...
import {
  ...
  TASK_STATUS_TODO, TASK_STATUS_DOING, TASK_STATUS_DONE, TASK_STATUS_DELAYED,
  ...
  NOTICE_STATUS_DRAFT, NOTICE_STATUS_PUBLISHED, NOTICE_STATUS_CLOSED,
  ...
  WEEKLY_REPORT_STATUS_DRAFT, WEEKLY_REPORT_STATUS_SUBMITTED, WEEKLY_REPORT_STATUS_REVIEWED, WEEKLY_REPORT_STATUS_ARCHIVED,
  MILESTONE_OPENING, MILESTONE_MIDTERM, MILESTONE_PRE_DEFENSE, MILESTONE_BLIND_REVIEW, MILESTONE_DEFENSE,
  MILESTONE_STATUS_PENDING, MILESTONE_STATUS_IN_PROGRESS, MILESTONE_STATUS_DONE, MILESTONE_STATUS_DELAYED,
...
export const TASK_STATUS_OPTIONS = [
  ...
  { label: '延期', value: TASK_STATUS_DELAYED }
]
...
export const APPROVAL_STATUS_OPTIONS = [
  ...
  { label: '已撤销', value: APPROVAL_STATUS_CANCELLED }
]
...
export const NOTICE_STATUS_OPTIONS = [
  ...
  { label: '已关闭', value: NOTICE_STATUS_CLOSED }
]
...
export const WEEKLY_REPORT_STATUS_OPTIONS = [
  { label: '草稿', value: WEEKLY_REPORT_STATUS_DRAFT },
  { label: '已提交', value: WEEKLY_REPORT_STATUS_SUBMITTED },
  { label: '已批注', value: WEEKLY_REPORT_STATUS_REVIEWED },
  { label: '已归档', value: WEEKLY_REPORT_STATUS_ARCHIVED }
]

export const MILESTONE_TYPE_OPTIONS = [
  { label: '开题', value: MILESTONE_OPENING },
  { label: '中期', value: MILESTONE_MIDTERM },
  { label: '预答辩', value: MILESTONE_PRE_DEFENSE },
  { label: '盲审', value: MILESTONE_BLIND_REVIEW },
  { label: '答辩', value: MILESTONE_DEFENSE }
]

export const MILESTONE_STATUS_OPTIONS = [
  { label: '未开始', value: MILESTONE_STATUS_PENDING },
  { label: '进行中', value: MILESTONE_STATUS_IN_PROGRESS },
  { label: '已完成', value: MILESTONE_STATUS_DONE },
  { label: '延期', value: MILESTONE_STATUS_DELAYED }
]
